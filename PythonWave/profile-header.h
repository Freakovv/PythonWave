...
Void profile::buttonCloseEnd_Click(System::Object^ sender, System::EventArgs^ e) {
	ClassFade^ Fade = gcnew ClassFade(this);
	Fade->SetAnimation("close");
	Fade = nullptr;
}

Void profile::guna2TrackBar1_Scroll(System::Object^ sender, System::Windows::Forms::ScrollEventArgs^ e) {
	borderlessForm->BorderRadius = TrackBorderForm->Value;
	labelBorderForm->Text = Convert::ToString(TrackBorderForm->Value);
}
Void profile::guna2ToggleSwitch1_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
	dragSettings->TransparentWhileDrag = toggleTransparent->Checked;
}
Void profile::toggleShadows_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
...
Void profile::guna2CircleButton1_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageInfo->Show("Эта функция на стадии ранней разработки");
}
Void profile::guna2TrackBar2_Scroll(System::Object^ sender, System::Windows::Forms::ScrollEventArgs^ e) {
	labelVolume->Text = Convert::ToString(TrackVolume->Value);
}
Void profile::guna2TrackBar3_Scroll(System::Object^ sender, System::Windows::Forms::ScrollEventArgs^ e) {
	buttonResume1->BorderRadius = TrackBorderBtn->Value;
	labelBorderBtn->Text = Convert::ToString(TrackBorderBtn->Value);
}
Void profile::guna2Button1_Click(System::Object^ sender, System::EventArgs^ e) {
	Pages->SelectTab(pageSettings);
}
